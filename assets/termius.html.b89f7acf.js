import{_ as s,o as n,c as e,a}from"./app.be79adef.js";const i={},c=a(`<h1 id="终端-vi-编辑显示行号" tabindex="-1"><a class="header-anchor" href="#终端-vi-编辑显示行号" aria-hidden="true">#</a> 终端 VI 编辑显示行号</h1><ul><li>打开终端</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 复制 vim 配置模版</span>
